...
<div class="overlay">
    ...
    <div class="services" style="margin-top: 180px;">
    <div class="services__wrapper">
        <div class="services__main-title" >
            <span style="color: #f24634; margin-bottom: 30px">Услуга временно недоступна</span>
            <br>
            <span>Попробуйте в приложении Kaspi.</span>
        </div>
    </div>
    <div class="app-qr__image" style="margin-bottom: 90px; margin-top: -30px">
