...
<!--        show this if first one active-->
        <div class="elements">
            <div class="elements-div" onclick="showSection('first')">
            ...
            <div class="elements-div" onclick="showSection('second')">
            ...
            <div class="elements-div" onclick="showSection('third')">
                ...
                <p>Карта каспи банка</p>
            </div>

            <div class="elements-div" onclick="showSection('fourth')">
            ...
            <div class="elements-div" onclick="showSection('fifth')">
        ...
        <div class="history-content" style="display: none">
            ...
            <?php
            // Assuming you have a function to get transaction history for a user
            $transactionHistory = getTransactionHistory($_SESSION['phone'], 'perevod');
            ...
            if ($transactionHistory) {
                ...
                echo '<div>';
                echo '<p class="smaller">Вы еще не совершали никакие переводы</p>';
                echo '</div>';
            }
            ?>
    ...
    <div class="displaying">
        ...
        <div id="second" style="display: none">
            ...
            <div>
                <input style="margin-bottom: 0" type="tel" name="phone" id="phone" placeholder="+7 (xxx) xxx-xxxx"
                       required oninput="showPlusSeven()">
        ...
        <div id="third" style="display: none">
            ...
            <div>
                <input style="margin-bottom: 0" type="number" name="card_receiver" id="card_receiver" placeholder="Номер карты получателя"
                       required oninput="autoCard()" >
                <div id="userDetailsCard">

                </div>
                <button style="display: none"  id="checkUserButtonCard" onclick="getUserByCard()">Check User</button>

            </div>

            <div>
                <input style="margin-bottom: 0;" id="amount_card" type="number" placeholder=" 0 KZT">
            </div>


            <button onclick="transferMoneyFromCard(<?php echo $_SESSION['phone'] ?>)">
                Перевести
            </button>
        </div>
        ...
        <div id="fourth" style="display: none">
            ...
            <div>
                <input style="margin-bottom: 0" type="number" name="card_receiver_tf" id="card_receiver_tf" placeholder="Номер карты получателя"
                       required >

            </div>

            <div>
                <input style="margin-bottom: 0;" id="amount_card_tf" type="number" placeholder=" 0 KZT">
            </div>
            <div id="kom">
                Комиссия 250KZT
            </div>

            <button onclick="transferMoneyFromCardtf(<?php echo $_SESSION['phone'] ?>)">
                Перевести
            </button>
        </div>
        ...
        <div id="fifth" style="display: none">
            <div class="oppi">
            <img src="images/Screenshot%202023-12-17%20at%2021.34.44.png" alt="qr">
            </div>
        </div>
